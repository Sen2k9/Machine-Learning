...
........................
How to Run the code:
1.Extract ML_Project_Group.rar file and copy java file from src folder
2.In the test class put the file location in filename
...
To help to simulate the code in shorter period we created a shorter version of given Netflix dataset(attached in zip file) named as
...
To simulate the code in a very small dataset we created an sample dataset(attached in the zip file) with the concept of Toy example given in collaborative filtering slide
named as "created_movie.txt", "created_rating.txt"
where we included 40 movies with 12 users with randomly given rating from 1-5
